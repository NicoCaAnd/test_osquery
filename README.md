...
Without any modification, the binary will run on Android system (with a recent Linux Kernel version >=4.9), and some GNU-Linux tables are available. But following the Osquery documentation, and studying Android specifications, we can make some specific Android tables.
